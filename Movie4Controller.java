...
public class Movie4Controller  {
	
	private Movie4Model model;
	private Movie4View view;
	
    public Movie4Controller(Movie4Model movie4model, Movie4View movie4view) {        
        this.model = movie4model;
        this.view = movie4view;
  ...
  //setters and getters---------------------------
    ...
    public void updateView() {
		view.updateMovie4View(model.getMovieName(), model.getAgeRating(), model.getDescription() );
	}
