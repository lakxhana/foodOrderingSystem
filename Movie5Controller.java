...
public class Movie5Controller  {
	
	private Movie5Model model;
	private Movie5View view;
	
    public Movie5Controller(Movie5Model movie5model, Movie5View movie5view) {        
        this.model = movie5model;
        this.view = movie5view;
  ...
  //setters and getters---------------------------
    ...
    public void updateView() {
		view.updateMovie5View(model.getMovieName(), model.getAgeRating(), model.getDescription() );
	}
