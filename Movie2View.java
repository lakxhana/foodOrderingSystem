...
public class Movie2View extends Showtime2View{

	JPanel panel1 = new JPanel();
	String movieName = "Haikyuu";
	...
	//JLabel descriptionTop = new JLabel("Sypnopsis: ");
	String description = "<html>Sypnopsis:Shoyo Hinata joins Karasuno high school's volleyball team to emulate his idol, the Little Giant; but he has to team up with Tobio Kageyama, his former rival.</html>";
	//String description = "<html>Sypnopsis:Eleven-year-old Riley has moved to San Francisco, leaving behind her life in Minnesota. She and her five core emotions, Fear, Anger, Joy, Disgust, and Sadness, struggle to cope with her new life.</html>";
	JLabel descriptionLabel = new JLabel(description);
	
	public Movie2View() {
		updateMovie2View(movieName, ageRating, description); // Update the view for Movie1Viezw	
    }
	
	//calling variables movieName, ageRating, description
	public void updateMovie2View(String name, String ageRate, String desc) {
