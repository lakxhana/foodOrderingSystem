...
public class Movie3View extends Showtime2View{
	...
	String description = "<html>Sypnopsis:Barbie and Ken are having the time of their lives in the colorful and seemingly perfect world of Barbie Land. However, when they get a chance to go to the real world, they soon discover the joys and perils of living among humans.</html>";
	JLabel descriptionLabel = new JLabel(description);
	
	public Movie3View() {
		updateMovie3View(movieName, ageRating, description); // Update the view for Movie1Viezw	
    }
	
	//calling variables movieName, ageRating, description
	public void updateMovie3View(String name, String ageRate, String desc) {
