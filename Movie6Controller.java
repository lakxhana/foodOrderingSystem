...
public class Movie6Controller  {
	
	private Movie6Model model;
	private Movie6View view;
	
    public Movie6Controller(Movie6Model movie6model, Movie6View movie6view) {        
        this.model = movie6model;
        this.view = movie6view;
  ...
  //setters and getters---------------------------
    ...
    public void updateView() {
		view.updateMovie6View(model.getMovieName(), model.getAgeRating(), model.getDescription() );
	}
