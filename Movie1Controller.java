...
public class Movie1Controller  {
	...
	private Movie1Model model;
	private Movie1View view;
	
    public Movie1Controller(Movie1Model movie1model, Movie1View movie1view) {        
        this.model = movie1model;
        this.view = movie1view;
    ...
    public void updateView() {
		view.updateMovie1View(model.getMovieName(), model.getAgeRating(), model.getDescription() );
	}
