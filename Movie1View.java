...
public class Movie1View extends Showtime2View{
	...
	public Movie1View() {
		updateMovie1View(movieName, ageRating, description); // Update the view for Movie1Viezw	
    }
	
	//calling variables movieName, ageRating, description
	public void updateMovie1View(String name, String ageRate, String desc) {
