...
public class Movie2Controller  {
	...
	private Movie2Model model;
	private Movie2View view;
	
    public Movie2Controller(Movie2Model movie2model, Movie2View movie2view) {        
        this.model = movie2model;
        this.view = movie2view;
  ...
  //setters and getters---------------------------
    ...
    public void updateView() {
		view.updateMovie2View(model.getMovieName(), model.getAgeRating(), model.getDescription() );
	}
