...
public class Movie5View extends Showtime2View{

	JPanel panel1 = new JPanel();
	String movieName = "Final Girl";
	JLabel movieNameLabel = new JLabel("MovieTitle: " + movieName);
	String ageRating = "R-rating";
	JLabel ageRatingLabel = new JLabel("Age Rating: " + ageRating);
	
	JPanel panel2 = new JPanel();
	String description = "<html>Sypnopsis:Four sadistic teenage boys hunt and kill women for sport. When Veronica, a new girl in town, becomes their new target, they get more than they bargained for.</html>";
	JLabel descriptionLabel = new JLabel(description);
	
	public Movie5View() {
		updateMovie5View(movieName, ageRating, description); // Update the view for Movie1Viezw	
    }
	
	//calling variables movieName, ageRating, description
	public void updateMovie5View(String name, String ageRate, String desc) {
